...
const TeachingDetails = ({ tutorData }) => {
  ...
  useEffect(() => {
      if (tutorData) {
        setSubjects(tutorData.sub || []);
        setLanguages(tutorData.lang || []);
        setHourlyRate(tutorData.hourlyRate || "");
        setTeachOnline(tutorData.teachOnline || false);
        setstateName(tutorData.state || "");
        setCityName(tutorData.city || "");
        setLocations(tutorData.locations || "");
        setCredits(tutorData.credits || 0);
      }
  }, [tutorData]);
